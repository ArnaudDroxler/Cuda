...
public class UseAdd
	...
	private static void useAdd2()
		{
		Function_I h = x -> x*2.0;
		Function_I g = x -> x+1.0;
	...
	private static void useAdd3()
		...
		Function_I u1 = FunctionAdd.add1(x -> x*2.0, x -> x+1.0);
		Function_I u2 = FunctionAdd.add2(x -> x*2.0, x -> x+1.0);
		Function_I u3 = FunctionAdd.add3(x -> x*2.0, x -> x+1.0);
