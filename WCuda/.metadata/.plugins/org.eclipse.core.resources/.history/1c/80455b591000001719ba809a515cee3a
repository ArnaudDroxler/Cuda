...
Mandelbrot::Mandelbrot(uint w, uint h, uint dt,  const DomaineMath& domaineMath) :
	Animable_I<uchar4>(w, h, "Mandelbrot_OMP_rgba_uchar4",domaineMath), variateurAnimation(Interval<int>(30, 100), dt)
    {
...
void Mandelbrot::processForAutoOMP(uchar4* ptrTabPixels, uint w, uint h, const DomaineMath& domaineMath)
    {
    MandelbrotMath mandelbrotMath((int)t); // ici pour preparer cuda
